package com.example.trainingconstructor.InterfaceScreen.ConstructionScreen.ExerciseScreen;
...
public class CreateExerciseFragment extends Fragment {
    ...
    private com.example.trainingconstructor.InterfaceScreen.ConstructionScreen.ExerciseScreen.CreateExerciseFragment.FragmentListener listener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof com.example.trainingconstructor.InterfaceScreen.ConstructionScreen.ExerciseScreen.CreateExerciseFragment.FragmentListener){
            listener=(com.example.trainingconstructor.InterfaceScreen.ConstructionScreen.ExerciseScreen.CreateExerciseFragment.FragmentListener) context;
        }
    }
