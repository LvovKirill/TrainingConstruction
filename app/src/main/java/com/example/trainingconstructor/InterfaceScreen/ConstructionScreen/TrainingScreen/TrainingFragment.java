...
import com.example.trainingconstructor.InterfaceScreen.ConstructionScreen.TrainingScreen.AddPoint.AddPointExersisePagerFragment;
import com.example.trainingconstructor.InterfaceScreen.TabataTimerScreen.TabataTimerFragment;
import com.example.trainingconstructor.R;
import com.example.trainingconstructor.Views.RecyclerViews.TrainingFromExerciseRV.TrainingFromExerciseAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AddPointExersisePagerFragment myFragment = AddPointExersisePagerFragment.newInstance(getArguments().getInt("ID"));
